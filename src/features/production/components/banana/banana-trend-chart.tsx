...
import { useBananaLoadTrends } from "@/features/production/hooks/use-banana-production";

export function BananaTrendChart() {
    ...
    const { data: trendsData, isLoading: isLoadingTrends } = useBananaLoadTrends(latestLoadId, days);
        ...
        <Card className="shadow-sm gap-0 p-6 relative">
            ...
            <div className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <CardDescription>Banana mass collected per day {latestLoadId && <span className="lowercase font-mono text-[9px] bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded ml-2 text-gray-500">load: {latestLoadId.slice(0, 8)}</span>}</CardDescription>
                </div>
