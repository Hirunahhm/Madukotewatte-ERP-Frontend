...
import { useManiocVarietyBreakdown } from "@/features/production/hooks/use-manioc-production";

export function ManiocVarietyChart() {
    const { data, isLoading } = useManiocVarietyBreakdown();
    ...
    return (
        <Card className="shadow-sm gap-0 p-6 relative">
            ...
            <CardDescription className="mb-4">Total mass collected per manioc variety</CardDescription>
