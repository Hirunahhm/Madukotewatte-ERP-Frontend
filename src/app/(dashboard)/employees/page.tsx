    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-semibold text-brand-600 bg-brand-50 px-2.5 py-1 rounded-full border border-brand-200">128 Active Staff</span>
                    </div>
                ...
                <div className="flex items-center bg-white rounded-lg border border-gray-200 p-1">
                    ...
                    <button className="text-xs font-bold text-white bg-brand-500 px-3 py-1.5 rounded-md">Monthly</button>
                    <button className="text-xs font-bold text-gray-500 hover:bg-gray-50 px-3 py-1.5 rounded-md">Annual</button>
                    <button className="text-xs font-bold text-gray-500 hover:bg-gray-50 px-3 py-1.5 rounded-md">Lifetime</button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Card 1 */}
                <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm relative">
                    <div className="absolute top-4 right-4 bg-yellow-100 text-yellow-700 font-bold text-xs px-2 py-1 rounded-full">#1</div>
                    ...
                    <div className="flex items-end justify-between border-t border-gray-50 pt-4">
                        ...
                        <span className="text-[10px] font-bold text-gray-500 bg-gray-100 px-2 py-1 rounded">Elite Tier</span>
                    </div>
                </div>
                {/* Card 2 */}
                <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm relative">
                    <div className="absolute top-4 right-4 bg-gray-100 text-gray-600 font-bold text-xs px-2 py-1 rounded-full">#2</div>
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-full bg-gray-200"></div>
                        <div>
                ...
                {/* Card 3 */}
                <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm relative">
                    <div className="absolute top-4 right-4 bg-orange-100 text-orange-700 font-bold text-xs px-2 py-1 rounded-full">#3</div>
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-full bg-gray-200"></div>
                        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Daily latex collection average across all tappers (Litres)</p>
                        </div>
                        <button className="text-xs font-semibold text-gray-700 border border-gray-200 rounded p-1.5 px-3 hover:bg-gray-50">
                            Export PDF
                        </button>
                    </div>
                ...
                <div className="flex flex-col gap-6">
                    {/* Total Yield Card */}
                    <div className="rounded-xl bg-brand-500 p-6 flex-1 text-white relative overflow-hidden shadow-sm">
                    ...
                    {/* Productivity Card */}
                    <div className="rounded-xl border border-gray-100 bg-white p-6 flex-1 shadow-sm flex flex-col justify-center">
                ...
                <div className="p-4 border-b border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="relative w-full sm:w-96">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2 bg-gray-50 border-0 rounded-md text-sm focus:ring-1 focus:ring-brand-500"
                        />
                    </div>
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                        <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-md text-sm font-semibold hover:bg-gray-50">
                            <Download className="w-4 h-4" /> Bulk Attendance
                        </button>
                        <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-brand-500 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-brand-600 shadow-sm">
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="bg-gray-50/50 text-gray-500 font-semibold border-b border-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-4">Trees (Today)</th>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {employees.map((emp, idx) => (
                                <tr key={idx} className="hover:bg-gray-50/50">
                                    ...
                                    <td className="px-6 py-3 text-gray-500 text-xs font-medium">{emp.lastActivity}</td>
                                    <td className="px-6 py-3">
