...
export default function LoginPage() {
    ...
    const onSubmit = async (_data: LoginFormValues) => {
        // Backend connection pending — simulate network delay
            ...
            <div className="w-full rounded-2xl p-8 space-y-5
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        />
                        {errors.employeeId && (
                            <p id="employeeId-error" role="alert" className="flex items-center gap-1.5 text-xs text-red-500 dark:text-red-400 pt-0.5">
